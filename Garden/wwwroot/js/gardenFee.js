...
$('#gardenFee_dt').DataTable({
    'ajax': {
        'url': "/GardenFees/GetGardenFeeList",
        'type': 'GET',
        'datatype': 'json'
    },
    'columns': [
        {
            'data': 'gardenUser', 'className': 'text-left m-2',
